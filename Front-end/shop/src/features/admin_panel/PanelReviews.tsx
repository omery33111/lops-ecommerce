    ...
    <tbody>
      {[...reviews].reverse().map((review: Review) => (
        <tr key={review.id} style={{ backgroundColor: "white" }}>
          <td style={{ textAlign: "center", verticalAlign: "middle" }}>{review.id}</td>
          <td style={{ textAlign: "center", verticalAlign: "middle" }}>
            <Image src={myServer + review.picture} alt="review" height={100} width={120} />
          </td>
          <td style={{ textAlign: "center", verticalAlign: "middle" }}>{review.product}</td>
          <td style={{ textAlign: "center", verticalAlign: "middle"  }}>{review.rating} &#9733;</td>
          <td style={{ textAlign: "center", verticalAlign: "middle"  }}>{review.name}</td>
          <td style={{ textAlign: "center", verticalAlign: "middle"  }}>{review.comment}</td>
          <td style={{ textAlign: "center", verticalAlign: "middle"  }}>
            <button
              style={{
                color: "blue",
              ...
              onClick={() => navigate(`/admin_panel/user_details_update_review/${review.id}`)}>
              Edit
            </button>{" "}
            |{" "}
            <a
