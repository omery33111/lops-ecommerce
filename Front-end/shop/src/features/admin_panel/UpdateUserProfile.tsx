...
import { getSingleProfileAsync, patchUserProfileAsync, selectSingleProfile } from './panelSlice';
...
const UpdateUserProfile = () => {
    ...
    const handleSubmit = (e: any) => {
        ...
        dispatch(patchUserProfileAsync({ profileData: formData, id: String(single_profile.user) }));
            ...
            <div>
              ...
              >
                COMPLETE EDITING
                  ...
                  <br />
                  <Button
                  onClick = {() => navigate(`/admin_panel/user_details_addresses/${single_profile.user}`)}
                    variant="secondary"
