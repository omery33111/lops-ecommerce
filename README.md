...
[![Live Netlify Server](https://img.shields.io/badge/Live%20on-Netlify-00ad9f.svg)](https://lops.netlify.app/)
...
### Deployments
The front-end of my website is hosted by [Netlify](https://lops.netlify.app/) while the database back-end is hosted on [Render](https://render.com/), allowing for seamless integration and efficient website management.
